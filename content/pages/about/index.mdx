...
Currently, I’m focused on building [kirbyware LLC](https://www.kirbyware.io/) -  a business dedicated to enabling companies and teams exploit the potential of transformational technologies through a range of technology services, customized software solutions, and expert guidance.
...
<Text>Links:</Text>
     ...
     variant='outline' 
     href={resumeFile}
     >Resume</ExternalButton>

     <ExternalButton
     sx={{ px: 2, ml: 4,  }} 
     variant='outline' 
     href='https://github.com/kirbymark'
     >Github</ExternalButton>

     <ExternalButton
     sx={{ px: 2, ml: 4,  }} 
     variant='outline' 
     href='https://stackshare.io/kirbymark/my-stack'
     >stackshare</ExternalButton>
